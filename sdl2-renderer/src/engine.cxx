...
#define vectP_z(v, a, b) \
    ...
    for (int i = 0; i < len_1; i++) {
        ...
        for (j = 0; j < len_2; j++) {
            ...
            if (vectP_z(array_1[next_i], array_1[i], array_2[j]) *
                        vectP_z(array_1[next_i], array_1[i], array_2[next_j]) <
                    0 &&
                vectP_z(array_2[next_j], array_2[j], array_1[i]) *
                        vectP_z(array_2[next_j], array_2[j], array_1[next_i]) <
                    0)
                return true;
        }
    }
    ...
    for (j = 1; j < len_2; j++)
        if (a != vectP_z(array_2[j], array_2[j - 1], array_1[0]) < 0)
            break;
    if (j == len_2)
        return true;
    ...
    for (i = 1; i < len_1; i++)
        if (a != vectP_z(array_1[i], array_1[i - 1], array_2[0]) < 0)
            break;
    return i == len_1;
}
}    // namespace CHL
